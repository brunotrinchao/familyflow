...
class DashboardChartCategoryIncome extends ApexChartWidget
{
     ...
     * ID único do gráfico.
     */
    protected static ?string $chartId = 'categoryIncomeChart';
...
//    protected static ?int $contentHeight = 350;
    ...
    protected function getOptions(): array
    {
        ...
        return $service->getScriptDonutPie($total, 'Receitas por Categoria', 'categorias no periodo', $data, $labels,data:$categoryData->toArray());
    }
    ...
    protected function getDescription(): ?string
    {
        ...
        return "{$totalCategories} categorias com receitas";
    }
}
